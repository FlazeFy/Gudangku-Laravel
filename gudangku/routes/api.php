...
Route::prefix('/v1/stats')->middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('/inventory')->group(function () {
        ...
        Route::get('/tree_map', [QueriesStatsController::class, 'get_inventory_tree_map']);
    });
...
Route::prefix('/v1/stats')->group(function () {
    Route::prefix('/inventory')->group(function () {
        ...
        Route::get('/low_capacity_inventory_comparison', [QueriesStatsController::class, 'get_total_low_capacity_inventory_comparison']);
    });
    Route::prefix('/report')->group(function () {
...
Route::prefix('/v1/reminder')->middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/copy', [CommandsReminderController::class, 'copy_reminder']);
...
Route::prefix('/v1/report')->middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/item/{id}', [CommandsReportController::class, 'post_report_item']);
