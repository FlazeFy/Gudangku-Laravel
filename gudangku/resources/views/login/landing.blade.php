<style>
    .carousel-indicators button {
        width: var(--spaceXXSM) !important;
        height: var(--spaceXXSM) !important;
    }
</style>

<div class='d-inline-block mx-auto my-4' style='width:400px; text-align:center;'>
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item py-4">
                <br>
                <img src="{{asset('images/reminder.png')}}">
            ...
            <div class="carousel-item py-4">
                <br>
                <img src="{{asset('images/layout.png')}}">
