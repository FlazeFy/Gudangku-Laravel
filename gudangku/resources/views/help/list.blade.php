...
<div class="container bordered mb-4">
    ...
    <ol class="text-white ms-4" style="list-style-type: circle;">
        ...
        <li>A popup of recover confirmation will appear, click the button <b class="text-success">Yes, Sign Out</b> to process</li>
    </ol>
</div>
...
<div class="container bordered mb-4">
    ...
    <ol class="text-white ms-4" style="list-style-type: circle;">
        ...
        <li>After that you can fill the rest of the form for the optional field</li>
        <li>Press the <b class="text-success">Submit</b> button to finish your inventory add process</li>
    </ol>
</div>
<div class="container bordered mb-4">
    ...
    <ol class="text-white ms-4" style="list-style-type: circle;">
        ...
        <li>You <b class="text-success">will see</b> the <b>Inventory Name</b>, <b>Description</b>, <b>Category</b>, <b>Merk</b>, <b>Inventory Image</b>, <b>Favorite Status</b>, <b>Price</b>, <b>Unit & Capacity</b>, <b>Placement (Room, Storage, & Rack)</b>, <b>Reminder List</b>, and the <b>Properties</b>
        . You can use the page nativator at the bottom of the page</li>
        <li>If you want to edit or see more detail. Click the button <b class="text-success fst-italic">with edit icon</b> and it will takes you to Edit Page</li>
    </ol>
</div>
<div class="container bordered mb-4">
    ...
    <ol class="text-white ms-4" style="list-style-type: circle;">
        ...
        <li>Type the <b>Inventory Name</b> or <b>Inventory Merk</b> in the field <b>Search by Name or Merk</b>. <b class='text-success'>Escape or press enter</b> to submit</li>
    </ol>
</div>
<div class="container bordered mb-4">
    ...
    <ol class="text-white ms-4" style="list-style-type: circle;">
        <li>In the landing page, press the <b>My Inventory</b> menu</li>
        <li>It will takes you to My Inventory Page, find the section <b>"Control Panel"</b></li>
        <li>In the field <b>Search by Name or Merk</b>. Press the button with <b class="text-success fst-italic">X icon</b> to reset the name or merk search</li>
    </ol>
</div>
<div class="container bordered mb-4">
...
<div class="container bordered mb-4">
    ...
    <ol class="text-white ms-4" style="list-style-type: circle;">
        ...
        <li>A popup of delete confirmation will appear, click the button <b class="text-success">Yes, Delete</b> to process</li>
    </ol>
</div>
<div class="container bordered mb-4">
    ...
    <ol class="text-white ms-4" style="list-style-type: circle;">
        ...
        <li>A popup of recover confirmation will appear, click the button <b class="text-success">Yes, Recover</b> to process</li>
    </ol>
</div>
<div class="container bordered mb-4">
    ...
    <ol class="text-white ms-4" style="list-style-type: circle;">
        ...
        <li>A popup of recover confirmation will appear, click the button <b class="text-success">Yes, Delete</b> to process</li>
    </ol>
</div>
<div class="container bordered mb-4">
...
<div class="container bordered mb-4">
    ...
    <ol class="text-white ms-4" style="list-style-type: circle;">
        ...
        <li><b>Total Item Inventory By Favorite</b> present the data of total item or total price using pie chart, the data from all inventory separate by its like status</li>
        <li><b>Total Item Inventory By Merk</b> present the data of total item or total price using pie chart, the data from all inventory separate by its top used merk</li>
        <li><b>Total Inventory Created Per Month</b> present the data of total item and total price using line column chart, the data from total inventory created per month in a year</li>
        <li><b>Total Report Created Per Month</b> present the data of total item and total price using line column chart, the data from total report created per month in a year</li>
        <li><b>Total Report Spending Per Month</b> present the data of total item and total price using line column chart, the data from total report spending per month in a year</li>
        <li><b>Total Report Used Per Month</b> present the data of total item and total price using line column chart, the data from total report used per month in a year</li>
    </ol>
</div>
