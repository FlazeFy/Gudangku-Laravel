<div class="text-center">
    <br>
    <h2 class="text-primary mb-3">About GudangKu</h2>
    ...
    <div class="bordered p-3 mx-auto text-white mb-5" style="border-radius:var(--roundedLG); max-width:360px;">
        ...
        <p>My Name is <b>Leo</b>, a Bachelor's degree graduate in Software Engineering from Telkom University
        (2023). Focused on Web Development and Mobile Development. Enjoys exploring new knowledge and seeking challenges.
        If you want to do collaboration or do you want to send me feedback? you can find me on :</p>
