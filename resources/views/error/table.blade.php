    ...
    const getAllError = (page) => {
        ...
        $.ajax({
            ...
            error: function(response, jqXHR, textStatus, errorThrown) {
                Swal.close()
                response.status !== 404 ? generateAPIError(response, true) : templateAlertContainer(item_holder, 'no-data', "No error found to show", null, '<i class="fa-solid fa-scroll"></i>')
            }
        })
    }
    getAllError(page)
