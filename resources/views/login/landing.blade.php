    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active py-4">
                <br>
                <img src="{{asset('images/logo.png')}}" class='d-block mx-auto'>
                <h2>Welcome to Gudangku</h2><hr>
                <p class='mt-3 text-secondary'>Manage your home inventory</p>
                <br><br>
            </div>
            <div class="carousel-item py-4">
                <br>
                <img src="{{asset('images/inventory.png')}}" class='d-block mx-auto'>
                <h2>Warehouse in Your Pocket</h2><hr>
            ...
            <div class="carousel-item py-4">
                <br>
                <img src="{{asset('images/reminder.png')}}" class='d-block mx-auto'>
                <h2>Smart Reminders</h2><hr>
            ...
            <div class="carousel-item py-4">
                <br>
                <img src="{{asset('images/document.png')}}" class='d-block mx-auto'>
                <h2>Digital Document Hub</h2><hr>
            ...
            <div class="carousel-item py-4">
                <br>
                <img src="{{asset('images/layout.png')}}" class='d-block mx-auto'>
                <h2>Map Your Space</h2><hr>
